...
import kr.ac.tukorea4019.spgp1945.framework.objects.AnimSprite;
...
import kr.ac.tukorea4019.spgp1945.framework.util.Gauge;
...
public class Enemy extends AnimSprite implements BoxCollidable, Recyclable {
    ...
    protected static int[] bitmapIds = {
            R.mipmap.enemy_02,R.mipmap.enemy_02,R.mipmap.enemy_03,R.mipmap.enemy_04,R.mipmap.enemy_05,
